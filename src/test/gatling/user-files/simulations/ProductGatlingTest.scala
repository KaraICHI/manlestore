...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .post("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "productName":"SAMPLE_TEXT", "coverPrice":"0", "originPrice":"0", "produceDate":"2020-01-01T00:00:00.000Z", "period":"0", "figure":"SAMPLE_TEXT", "brand":"SAMPLE_TEXT", "supply":"SAMPLE_TEXT", "brief":"SAMPLE_TEXT", "description":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
