...
import { ArticalDialogComponent } from '../../../../../../main/webapp/app/entities/artical/artical-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Artical Management Dialog Component', () => {
        let comp: ArticalDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(ArticalDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'articalListModification', content: 'OK'});
