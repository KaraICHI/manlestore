...
describe('Service Tests', () => {
    ...
    describe('ArticalCommentReply Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ArticalCommentReplyService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/artical-comment-replies';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ArticalCommentReply', () => {
