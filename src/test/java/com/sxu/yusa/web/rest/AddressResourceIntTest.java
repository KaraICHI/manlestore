...
import com.sxu.yusa.repository.AddressRepository;
import com.sxu.yusa.service.AddressService;
import com.sxu.yusa.service.dto.AddressDTO;
import com.sxu.yusa.service.mapper.AddressMapper;
...
public class AddressResourceIntTest {
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getConsignee()).isEqualTo(DEFAULT_CONSIGNEE);
    ...
    public void updateAddress() throws Exception {
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getConsignee()).isEqualTo(UPDATED_CONSIGNEE);
